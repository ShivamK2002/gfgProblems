...
class Solution {
    ...
    Pair solve(Node node) {
        ...
        Pair leftPair = new Pair(null, null);
        Pair rightPair = new Pair(null, null);
        ...
        if (node.right != null) {
            ...
            lastNode = rightPair.second;
        } else {
            lastNode = node;
        }

        return new Pair(firstNode, lastNode);
    }

    Node flattenBST(Node root) {
        return solve(root).first;  // Code here
    }
}